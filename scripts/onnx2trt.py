...
def load_plugins(logger: trt.Logger):
    ...
    if platform.system().lower() == 'linux':
        ctypes.CDLL("/home/grid-sample3d-trt-plugin/build/libgrid_sample_3d_plugin.so", mode=ctypes.RTLD_GLOBAL)
    else:
...
def main(args):
    ...
    builder.create_network(args.onnx.replace("\r", ""))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--onnx", help="The input ONNX model file to load",
                        default="../checkpoints/liveportrait_onnx/stitching_lip.onnx")
