...
class TensorRTPredictor:
    ...
    def __init__(self, **kwargs):
        ...
        if platform.system().lower() == 'linux':
            ctypes.CDLL("/home/comfui-storage/ComfyUI/custom_nodes/FasterLivePortraitWithAnimal-custom/checkpoints/liveportrait_onnx/libgrid_sample_3d_plugin.so", mode=ctypes.RTLD_GLOBAL)
        else:
